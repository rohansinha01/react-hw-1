...
const Main = (props) => {
    ...
    <div style={{color: "orange", textShadow: "1px 1px 2px pink"}}><Projects project="3" title="Group Project" description="Possibly the greatest Group Project GA has ever seen." link="https://www.youtube.com/watch?v=dQw4w9WgXcQ" github="https://www.youtube.com/watch?v=47n6v4e3QJE" /></div>
    </div>
}
